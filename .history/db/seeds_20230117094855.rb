...
fuel_stations = FuelStation.create([
    ...
    {name: "Total energies" , phone_number: " 0722 907528", exact_location:"lavington" ,  county:"Nairobi County" , description:"Rubis" , email:"mechanic.com" , distance:"15km" , logo:"https://images.unsplash.com/photo-1560005262-823d9a06c851?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8ZnVlbCUyMHN0YXRpb258ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" },
